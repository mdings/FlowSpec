...
#ifndef FLOWSPECEDITOR_SWIFT_H
#define FLOWSPECEDITOR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlowSpecEditor",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC14FlowSpecEditor16EditorScrollView")
