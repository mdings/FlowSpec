...
const GO_TO_ARGUMENTS = {
  ...
  with: "With supplies named context, input, or instructions to the destination.",
  without: "Without explicitly omits named context or input, even when it is available in the current scope.",
  example: [
