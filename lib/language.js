...
const DIRECTIVES = [
  ...
  { name: "Entry", type: "entry", category: "metadata", description: "An external trigger through which the owning Flow can begin.", example: "Entry App launch", trailingSpace: true },
